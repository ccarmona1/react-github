    ...
    return (
      <Card className="card-2xl">
        <div className="flex flex-col items-center justify-center py-16 gap-4">
          ...
          />
          <h2 className="heading-2 text-center">Repository not found</h2>
          <p className="text-gray-empty text-center max-w-md">
            The repository you are looking for does not exist or could not be
            loaded. Please check the URL or try again later.
          </p>
          <Link
            to={`/${organizationName}`}
            className="btn-base flex items-center gap-2 w-fit mt-4"
            role="button"
            tabIndex={0}
          >
            <DynamicIcon
